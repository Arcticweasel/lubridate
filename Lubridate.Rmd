...
df <- df %>% 
    mutate(Quarter = round_date(x = stop_date_time, unit = "quarter"),
           Floor_Quarter = floor_date(stop_date_time, "quarter"),
           Ceiling_Quarter = ceiling_date(stop_date_time, "quarter"))
...
- R uses international standardt time zones displayed in `<continent>/<city>`  
